...
class TaskInfo(_message.Message):
    __slots__ = ("request_id", "id", "infer_worker", "cache_worker", "token_num", "index", "task_type", "type", "task_num", "cache_pages_list")
    ...
    def __init__(self, request_id: _Optional[int] = ..., id: _Optional[int] = ..., infer_worker: _Optional[int] = ..., cache_worker: _Optional[int] = ..., token_num: _Optional[int] = ..., index: _Optional[int] = ..., task_type: _Optional[int] = ..., type: _Optional[str] = ..., task_num: _Optional[int] = ..., cache_pages_list: _Optional[_Iterable[int]] = ...) -> None: ...
