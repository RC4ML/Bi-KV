...
def set_template(args):
    ...
    # if "Llama-3" in args.llm_base_model:
    #     args.pattern_function = find_goods_index_llama3
    # else:
    #     args.pattern_function = find_goods_index
...
parser.add_argument("--from_checkpoints",type=bool,default=False)
...
parser.add_argument('--llm_input_template_reverse', type=str, \
...
# Evaluate
################
parser.add_argument('--reverse_prompt', type=bool, default=False)
