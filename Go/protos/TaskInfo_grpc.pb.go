...
const (
	...
	CacheCoordinatorService_ReceiveTasksFromScheduler_FullMethodName   = "/CacheCoordinatorService/ReceiveTasksFromScheduler"
...
type CacheCoordinatorServiceClient interface {
	...
	ReceiveTasksFromScheduler(ctx context.Context, in *TaskInfoList, opts ...grpc.CallOption) (*ComfirmationMessage, error)
...
func (c *cacheCoordinatorServiceClient) ReceiveTasksFromScheduler(ctx context.Context, in *TaskInfoList, opts ...grpc.CallOption) (*ComfirmationMessage, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ComfirmationMessage)
	err := c.cc.Invoke(ctx, CacheCoordinatorService_ReceiveTasksFromScheduler_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CacheCoordinatorServiceServer interface {
	...
	ReceiveTasksFromScheduler(context.Context, *TaskInfoList) (*ComfirmationMessage, error)
...
func (UnimplementedCacheCoordinatorServiceServer) ReceiveTasksFromScheduler(context.Context, *TaskInfoList) (*ComfirmationMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReceiveTasksFromScheduler not implemented")
}
...
func _CacheCoordinatorService_ReceiveTasksFromScheduler_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskInfoList)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CacheCoordinatorServiceServer).ReceiveTasksFromScheduler(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CacheCoordinatorService_ReceiveTasksFromScheduler_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CacheCoordinatorServiceServer).ReceiveTasksFromScheduler(ctx, req.(*TaskInfoList))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CacheCoordinatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReceiveTasksFromScheduler",
			Handler:    _CacheCoordinatorService_ReceiveTasksFromScheduler_Handler,
		},
		{
